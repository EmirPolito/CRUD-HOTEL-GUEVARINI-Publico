...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "SELECT u.id_usuario, u.nombre_completo, u.password, u.id_rol, u.verificado, r.nombre_rol 
              FROM usuarios u 
    ...
    if ($stmt->rowCount() > 0) {
        ...
        if($password === $usuario['password']){
            if($usuario['verificado'] == 0){
                $_SESSION['error_login'] = "Debes verificar tu email antes de iniciar sesión.";
